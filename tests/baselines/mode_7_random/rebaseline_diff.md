...
## Timing: FAIL — state #6 is +9366 cycles (+0.585 ms) from baseline (tolerance 8000)
- Affected pattern: during "gpio C2=0"
- Baseline: cycle 12415096 (775.943 ms, raw seq 62); actual: cycle 12424462 (776.529 ms, raw seq 62)
